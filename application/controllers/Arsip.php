...
class Arsip extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(['arsip_m', 'konsumen_m']);
	}
...

	{
		...
		$data ['konsumen']=$this->konsumen_m->get();		
				
		$this->template->load('template', 'arsip/arsip_form',$data);
	}
	...
	public function simpan_arsip()
	{
                ...
                if(!$this->upload->do_upload('ktp')){
	                ...
	                $inputFileName = './uploads/arsip/slipgaji' .$media8['file_name'];
